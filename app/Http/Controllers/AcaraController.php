...
class AcaraController extends Controller
{
    ...
    {
        $acara = Acara::where('tipe_acara', 'berbayar')->select('id', 'nama_acara', 'tempat_acara', 'thumbnail', 'slug', 'publish')->get();

        return Inertia::render('dasbor/acara/page', ['acara' => $acara]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('dasbor/acara/buat', ['survei' => $survei, 'kategori' => $kategori]);
    }
    ...
    public function edit($slug)
    {
        ...
        return Inertia::render('dasbor/acara/ubah', ['acara' => $acara, 'kategori' => $kategori, 'survei' => $survei, 'akordeon' => $akordeon]);
    }
